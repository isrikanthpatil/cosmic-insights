...
<style>
  * { box-sizing: border-box; }
  ...
  .mark { width: 30px; height: 30px; border-radius: 9px; display: inline-flex; align-items: center;
    justify-content: center; background: rgba(184,137,47,0.12); border: 1px solid rgba(184,137,47,0.50);
    color: #B8892F; font-size: 17px; line-height: 1; }
  .brand { font-family: Georgia, serif; font-size: 21px; color: #1A1638; letter-spacing: .3px; }
...
<body><div class="page">
  ...
  ${bodyHtml}
  <div class="footer">Prepared on ${esc(today())} · Astropanth · Vedic (sidereal / Lahiri) calculations · astropanth.com<br>
